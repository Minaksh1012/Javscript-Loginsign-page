...
const fs=require('fs')
var file=fs.existsSync("minakshi.json")
...
if (file==false){
    ...
    fs.writeFileSync("minakshi.json",JSON.stringify(mylist,null,4))
    ...
    if (login_signup=="1"){
        ...
        data1=fs.readFileSync("minakshi.json","utf8")
